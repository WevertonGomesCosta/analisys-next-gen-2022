...
author: 
  ...
  - Oliveira, E. J.^[Eder Jorge de Oliveira, Pesquisador e Coordenador do Projeto, Embrapa Mandioca e Fruticultura]
date: "`r Sys.Date()`"
...
number_trials_year %>%
  ...
  geom_text(aes(x = studyYear, y = n + 1, label = n), size = 8, vjust = 0) +
  theme_bw() +
...
number_traits_year %>%
  ...
  geom_text(aes(x = studyYear, y = sum, label = sum), vjust = -0.5, size = 7) +
  theme_bw() +
